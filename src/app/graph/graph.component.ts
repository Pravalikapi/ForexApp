...
//   country1: string = '';
//   country2: string = '';
//   country1Rate: number | undefined;
//   country2Rate: number | undefined;
//   chartData: number[] = [];
//   chartLabels: string[] = [];
...
//     this.country1Rate = this.getExchangeRate(this.country1);
//     this.country2Rate = this.getExchangeRate(this.country2);

//     if (ctx && this.country1Rate !== undefined && this.country2Rate !== undefined) {
//       this.chartData = [this.country1Rate, this.country2Rate];
...
//       });
//     } else {
//       console.log("Exchange rate not found for selected countries.");
//     }
//   }
// }
